...
os.chdir(os.path.join(_HERE, "peak_reshuffle"))
...
files
files_peak = os.listdir("../../last_100_main/last_100_reshuffle")
files_peak = [f for f in files_peak if "run1" in f]
files_peak = ["../../last_100_main/last_100_reshuffle/" + x for x in files_peak]
files_peak
len(files_peak)
files = files + files_peak
len(files)
...
#plt.savefig('fig_reshuffle_peak100_overlay_all_r1.pdf', format="pdf", bbox_inches='tight', transparent=True)
plt.savefig('../../../figures/fig3b.pdf', format="pdf", bbox_inches='tight', transparent=True)
plt.show()
