...
plt.plot(differences.iloc[9,:], color="purple", alpha=0.25, linewidth=1)
...
#plt.savefig('fig_reshuffle_peak100_diff.pdf', format="pdf", bbox_inches='tight', transparent=True)
plt.savefig('../../../figures/fig3d.pdf', format="pdf", bbox_inches='tight', transparent=True)
plt.show()
